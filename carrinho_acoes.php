...
/**
 * *Verificio se a variável de ações existe, para então verificar qual ação o usúario ordenou.
 */
if(isset($_GET['acao_carrinho']))  {
    ...
    $_SESSION['carrinho'] = array(); // Ao definir o carrinho com array novamente, limpamos ele.
    break;
 ...
 "total" => $total);
   ...
   case 'remover':
         ...
         if(isset($_SESSION['carrinho'][$item_carrinho])) { //verificando se o item realmente existe.
            unset($_SESSION['carrinho'][$item_carrinho]); //se existe, destroí o item
    break;}
    ...
    if(isset($_SESSION['carrinho'][$item_carrinho])) { // verificando se o item existe
        ...
        $_SESSION['carrinho'][$item_carrinho]['quantidade'] = $qnt; // definindo novamente a qnt.
